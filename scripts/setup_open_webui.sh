...
#   OPEN_WEBUI_NAME='Hermes Compras WebUI'
...
#   HERMES_API_MODEL_NAME='hermes-compras'

OPEN_WEBUI_PORT="${OPEN_WEBUI_PORT:-8080}"
OPEN_WEBUI_HOST="${OPEN_WEBUI_HOST:-127.0.0.1}"
OPEN_WEBUI_NAME="${OPEN_WEBUI_NAME:-Hermes Compras WebUI}"
...
HERMES_API_MODEL_NAME="${HERMES_API_MODEL_NAME:-hermes-compras}"
