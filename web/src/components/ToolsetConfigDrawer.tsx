...
export function ToolsetConfigDrawer({ toolset, profile, onClose, onChanged }: Props) {
  ...
  const isSearchToolset = toolset.name === "web" || toolset.name === "search";
    ...
    >
      ...
      >
        ...
        <header className="p-5 pb-3 border-b border-border">
          ...
          {isSearchToolset && (
            <p className="mt-2 rounded-md border border-amber-500/30 bg-amber-500/10 px-3 py-2 text-xs leading-relaxed text-amber-100">
              Search stays bound to the selected agent profile. Generic web
              search is disabled in the Hermes web UI; keep this toolset tied
              to the role you want to operate.
            </p>
          )}
