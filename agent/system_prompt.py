...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    persona_prompt = build_model_persona_prompt(getattr(agent, "model", ""))
    if persona_prompt:
        stable_parts.append(persona_prompt)

    stable_parts.append(build_sensitive_data_policy_block())
