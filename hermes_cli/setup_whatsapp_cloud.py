...
message permissions, auto-generates the verify token, and prints exact follow-up
...
def run_whatsapp_cloud_setup() -> int:
    ...
    if allowed:
        ...
        print("  ⚠ No message permissions set — inbound messages will be blocked.")
    ...
    print()
    print("    7. Send a test message from your phone.")
    print()
    print("─" * 50)
