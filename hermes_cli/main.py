...
def cmd_whatsapp(args):
    ...
    if not current_mode:
        ...
        print()
        print("  2. Personal number (bridge)")
        print("     You message the agent through your own number.")
        print("     Quick to set up, with the bridge handling inbound messages.")
        print()
        try:
        ...
        if choice == "1":
            ...
            save_env_value("WHATSAPP_MODE", "bridge")
            wa_mode = "bridge"
            print("  ✓ Mode: personal number (bridge)")
    else:
        wa_mode = current_mode
        mode_label = (
            "separate bot number" if wa_mode == "bot" else "personal number (bridge)"
        )
        print(f"\n✓ Mode: {mode_label}")
    ...
    if (session_dir / "creds.json").exists():
        ...
        if wa_mode == "bot":
            ...
            print("    2. Send a message to the WhatsApp number")
            print("    3. The agent will reply automatically")
            print()
        else:
            print("  Next steps:")
            print("    1. Start the gateway:  hermes gateway")
            print("    2. Open WhatsApp and message the bridge")
